      ...
      <div class="swiper-container">
        ...
        <section class="swiper-wrapper swiper-wrapper-new houses-sect">
          ...
          <div class="swiper-slide">
            <img src="Images/broken-car-1.jpg" alt="broken" class="slide-img">
          </div>

          <div class="swiper-slide">
            <img src="Images/broken-car-2.jpg" alt="broken" class="slide-img">
          </div>
          <div class="swiper-slide">
            <img src="Images/broken-car-3.jpg" alt="broken" class="slide-img">
          </div>
          <div class="swiper-slide">
            <img src="Images/broken-car-4.jpg" alt="broken" class="slide-img">
          </div>
